...
const baseAgentPrograms: AgentProgramInfo[] = [
  ...
  { id: 'kimi', displayName: 'Kimi', icon: 'kimi', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.kimi', appPath: '/Applications/Kimi.app', downloadUrl: 'https://www.kimi.com', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.kimi/skills', isCustom: false },
