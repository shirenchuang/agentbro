...
const baseAgentPrograms: AgentProgramInfo[] = [
  ...
  { id: 'copilot', displayName: 'GitHub Copilot', icon: 'copilot', kind: 'cli', status: 'notInstalled', packageManager: 'npm', packageName: '@github/copilot', installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.copilot', appPath: null, downloadUrl: 'https://docs.github.com/copilot/how-tos/set-up/install-copilot-cli', installCommand: 'npm install -g @github/copilot', updateCommand: 'npm install -g @github/copilot@latest', uninstallCommand: 'npm uninstall -g @github/copilot', hooksInstalled: false, skillsDir: '~/.copilot/skills', isCustom: false },
  ...
  { id: 'antigravity', displayName: 'Antigravity', icon: 'antigravity', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.gemini/config', appPath: macAppPath('/Applications/Antigravity.app'), downloadUrl: 'https://antigravity.google/download', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.gemini/config/skills', isCustom: false },
  ...
  { id: 'kimi', displayName: 'Kimi Code', icon: 'kimi', kind: 'cli', status: 'notInstalled', packageManager: 'npm', packageName: '@moonshot-ai/kimi-code', installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.kimi-code', appPath: null, downloadUrl: 'https://www.kimi.com/code/docs/kimi-code-cli/guides/getting-started.html', installCommand: 'npm install -g @moonshot-ai/kimi-code', updateCommand: 'npm install -g @moonshot-ai/kimi-code@latest', uninstallCommand: 'npm uninstall -g @moonshot-ai/kimi-code', hooksInstalled: false, skillsDir: '~/.kimi-code/skills', isCustom: false },
  { id: 'doubao', displayName: 'Doubao', icon: 'doubao', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/Library/Application Support/Doubao', appPath: macAppPath('/Applications/Doubao.app'), downloadUrl: 'https://www.doubao.com/download/desktop', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/Doubao/skills', isCustom: false },
  ...
  { id: 'zcode', displayName: 'ZCode', icon: 'zcode', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.zcode', appPath: macAppPath('/Applications/ZCode.app'), downloadUrl: 'https://zcode.z.ai/cn', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.zcode/skills', isCustom: false },
  ...
  { id: 'aider', displayName: 'Aider', icon: 'aider', kind: 'cli', status: 'notInstalled', packageManager: 'uv', packageName: 'aider-chat', installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.aider', appPath: null, downloadUrl: 'https://aider.chat', installCommand: 'uv tool install --force --python python3.12 --with pip aider-chat@latest', updateCommand: 'uv tool install --force --python python3.12 --with pip aider-chat@latest', uninstallCommand: 'uv tool uninstall aider-chat', hooksInstalled: false, skillsDir: '~/.aider/skills', isCustom: false },
